...
root_agent = Agent(
    ...
    instruction=
        ...
        have satisfied the user's requests.
        ...
        Before processing any user's request check the user's sentiment using 
        the sentiment_agent: in case of negative sentiment, you should  
        answer the user to keep it calm and suggest to contact again the
         service in the future. 
        """
    ,
    tools=[mcp_toolset],
    sub_agents=[sentiment_agent],
